This Ping utility alternative aims to deliver more features than the built-in 'ping' utility on mac and windows. The binaries and source code are available. 
build in visual studio code and .NET 7 (at this stage)
